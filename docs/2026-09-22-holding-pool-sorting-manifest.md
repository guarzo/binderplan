...
| Destination | Count |
|---|---:|
| Review · EDGE Watch · Unease | 2 |
| Review · EDGE Watch · Environmental Momentum | 4 |
| Review · Existing-theme EDGE | 5 |
| Review · REDUNDANT | 26 |
| Review · FUTURE SELF | 1 |
| **Review subtotal** | **38** |
| Keeper · Personal Keepers | 2 |
| Keeper · Beautiful Misfits | 6 |
| Keeper · Heritage | 23 |
| Keeper · Species Studies | 15 |
| **Keeper subtotal** | **46** |
| Trade · Core Value | 10 |
| Release | 3 |
| **Total** | **97** |

## Named comparisons for Existing-theme EDGE

These are comparison tests, not accepted swaps. A candidate remains EDGE only while this named challenge is genuinely open.
...
### Review binder — nine-pocket

1. **EDGE Watches, page 1:** Unease (2) and Environmental Momentum (4), leaving three deliberate empty pockets.
2. **Existing-theme EDGE, page 1:** five candidates, ordered Volume II then Volume I; four empty pockets.
3. **REDUNDANT, pages 1–3:** grouped by challenged theme, not species.
4. **FUTURE SELF, page 1:** one card; leave the remaining pockets open rather than filling them.
5. **Event Staging:** one empty page at the back.

This uses seven nine-pocket pages while preserving section boundaries.

### Keeper binder — four-pocket

- Personal Keepers: one page, two occupied.
- Beautiful Misfits: two pages, six occupied.
- Heritage: six pages, 23 occupied.
- Species Studies: four pages, 15 occupied.

Total: thirteen four-pocket pages, 46 occupied pockets, six open.

### Trade binder — four-pocket

Three pages, ten occupied pockets and two open event-supplement pockets.
...
- Treat every row as proposed until physically checked off.
- Confirm Trade/Core Value cards are actively available before placing them in the Trade binder.
- Do not release the three Release cards until the owner explicitly executes that decision.
- Keep Event Staging empty until an event is scheduled.
- Return any unswapped event supplement to its exact Review section.
- Photograph each finished section and append only executed classification decisions to durable records.
