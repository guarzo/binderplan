...
| jirachi-04 | Jirachi | 七夜のジラーチ | JP | Temple of Anger |  | uncertain | IMG_6865.HEIC 2026-08-01 | みらいよち/はめつのねがい attacks, distinct from jirachi-01..03, set from owner's doubleholo export 2026-09-18, no number in export |
...
| kasumis-tears-01 | Kasumi's Tears | カスミのなみだ | JP | Leaders' Stadium |  | uncertain | IMG_6865.HEIC 2026-08-01 | Trainer card, set from owner's doubleholo export 2026-09-18, no number in export |
